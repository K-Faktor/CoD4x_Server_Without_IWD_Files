# CoD4x Server [![build](https://github.com/K-Faktor/CoD4x_Server_Without_IWD_Files/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/K-Faktor/CoD4x_Server_Without_IWD_Files/actions/workflows/build.yml)
